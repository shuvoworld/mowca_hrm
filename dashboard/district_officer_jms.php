            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">জাতীয় মহিলা সংস্থা'র জেলা কর্মকর্তা'র তথ্য</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- /.col -->
                    ...
                    <div class="card-body">
                        ...
                        <table id="district_officer_jms_data" class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>জেলা</th>
...
<script>
    $(document).ready(function () {
        $('#district_officer_jms_data').DataTable({
            'processing': true,
            'serverSide': true,
            "orderMulti": true,
            "order": [[0, "asc"]],
            'serverMethod': 'post',
            'ajax': {
                'url': 'district_officer_jms_api.php',
                'data': function (data) {
        ...
        $('#filter_district').change(function () {
            $('#district_officer_jms_data').DataTable().draw();
        });
