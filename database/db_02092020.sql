...
CREATE TABLE `employees`  (
  ...
  `organization_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `posted_division_id` int(10) NULL DEFAULT NULL,
  `posted_division_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `posted_district_id` int(10) NULL DEFAULT NULL,
  `posted_district_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `posted_upazila_id` int(10) NULL DEFAULT NULL,
  `posted_upazila_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `organizations`  (
  ...
  `online_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `online_id_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT NULL,
  `is_active` tinyint(1) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'Ministry Admin', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'w19i5my51.png', NULL, 1, '2020-09-03 05:33:10');
