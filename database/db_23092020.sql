...
-- ----------------------------
INSERT INTO `organizations` VALUES (1, 'yiy', 'uyuii', 2, 1, 2, 'yuiuyi', 3, 30, 422, '787878', '2020-09-11 11:03:23', NULL, 1, NULL, '2020-09-11 11:03:47');
INSERT INTO `organizations` VALUES (2, 'sds', 'sdsds', 2, 1, 2, 'sds', 2, 18, 44, '3434fgfgf', '2020-09-11 11:35:11', 5, 1, 1, '2020-09-12 12:21:28');
INSERT INTO `organizations` VALUES (3, 'rtrtr', 'trtrt', 2, 2, 1, 'rtrt', 2, 19, 52, '4545', '2020-09-12 12:29:19', 5, 1, 1, '2020-09-12 12:30:33');
...
CREATE TABLE `posting`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `designation_id` int(10) NOT NULL,
  `designation_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `type_of_posting` int(10) NULL DEFAULT NULL,
  `employee_id` int(10) NOT NULL,
  `start_date` date NULL DEFAULT NULL,
  `end_date` date NULL DEFAULT NULL,
  `organization_id` int(10) NULL DEFAULT NULL,
  `organization_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `sanctionedposts`  (
  ...
  `organization_id` int(10) NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT NULL,
  `designation_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `organization_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'Ministry Admin', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'w19i5my51.png', NULL, 1, '2020-09-23 11:40:09');
