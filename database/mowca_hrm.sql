...
CREATE TABLE `employees`  (
  ...
  `national_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `mobile_no` varchar(12) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `posting`  (
  ...
  `current` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '',
  `created_at` datetime(0) NULL DEFAULT NULL,
  `reason_of_posting` int(10) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of posting
-- ----------------------------
INSERT INTO `posting` VALUES (10, 2, 19, 52, 190, 190, 1, 1, '2020-12-01', '0000-00-00', 'Yes', '2020-12-22 10:52:52', NULL, '2020-12-22 10:52:52');
...
INSERT INTO `sanctionedposts` VALUES (200, 2, 'উপজেলা মহিলা বিষয়ক কর্মকর্তা', 'উপজেলা মহিলা বিষয়ক কর্মকর্তার কার্যালয়,বাঞ্চারামপুর, ব্রাহ্মণবাড়িয়া', 2, 19, 51, 200, 'Filled', '2020-12-18 12:45:00');
...
INSERT INTO `sanctionedposts` VALUES (260, 2, 'উপজেলা মহিলা বিষয়ক কর্মকর্তা', 'উপজেলা মহিলা বিষয়ক কর্মকর্তার কার্যালয়,গাবতলী, বগুড়া', 3, 29, 388, 260, 'Filled', '2020-12-18 12:45:00');
...
FROM
	...
	LEFT JOIN posting AS p ON p.sanctionedpost_id = s.id
